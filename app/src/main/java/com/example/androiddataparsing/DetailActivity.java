...
public class DetailActivity extends AppCompatActivity {
    ...
    class ThreadEx extends Thread{
        public void run(){
            ...
            String result =null;
            try {
                URL url = new URL("http://192.168.0.69:8080//oracleserver/detail?itemid="+1);
    ...
    class ImageThread extends Thread{
        public void run(){
            try {
                URL url = new URL("Http://192.168.0.69:8080/oracleserver/img/"+image);
